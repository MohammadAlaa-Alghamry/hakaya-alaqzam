...
export default function VerifyByEmail() {
    return (
        ...
        <div className="flex flex-col justify-center items-center  py-[5%] w-[100%] sm:w-[60%] mx-auto ">
            <h1 className=" text-[#3E3625] text-center text-sm md:text-2xl">Verify your email</h1>
            <p className=" text-[#3E3625] w-[50%] mx-auto text-center font-semibold my-2  text-sm md:text-base">A text with a One Time password (OTP) has been sent to your email: example@email.com  <a href="" className="text-[#7f8341]">Change</a> </p>
